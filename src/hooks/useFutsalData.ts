...
export interface Player { id: number; name: string; name_en?: string | null; is_active: boolean; join_date: string; back_number: number | null; profile_image_url: string | null; age?: number | null; }
export interface Venue { id: number; name: string; }
export interface Match { id: number; date: string; venue_id: number; match_type: string; is_custom: boolean; has_detail_log: boolean; youtube_link: string | null; sub_venue?: string | null; match_format?: string | null; }
