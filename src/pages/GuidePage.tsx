...
const _LEGACY_UNUSED_GUIDE_SECTIONS = [
  {
    ...
    items: [
      ...
      { term: "쿼터별 승무패 (Quarter Form)", desc: "경기 전체 결과가 아닌, 본인이 실제 필드에서 뛰었던 쿼터들의 승/무/패를 쪼개어 분석한 지표입니다. 통계 탭 '쿼터별 폼 상세 분석'에서 1쿼터 강자/후반 쿼터 강자 정렬과 누적 막대 차트를 제공합니다. 버스 탑승 여부를 판독하는 정밀 데이터." },
    ],
  },
  {
    title: "⚽ 득점 루트 용어 사전",
  ...
  },
  {
    ...
    items: [
      ...
      { term: "🛡️ 까방권 보유", desc: "최근 3경기 중 한 경기에서 해트트릭(3골) 이상을 기록한 선수." },
    ],
  },
  {
    title: "📋 포메이션별 통계 가이드",
  ...
  },
  {
    ...
    items: [
      ...
      { term: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 잉글랜드 (허리케인 폼)", desc: "최근 5경기 합산 개인 득점 10골 이상. 잉글랜드의 허리케인 강림! 프리미어리그 득점왕급 폭격 폼을 보여줍니다." },
      ...
      { term: "🇩🇪 독일 (게겐프레싱의 화신)", desc: "최근 5경기 30쿼터 이상 출전 & 승률 50% 이상. 지치지 않는 철의 심장." },
