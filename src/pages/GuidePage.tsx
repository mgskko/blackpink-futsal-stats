...
const GUIDE_SECTIONS = [
  ...
  {
    title: "📉 폼 하락 경고 & 포지션별 승률",
    items: [
      { term: "📉 폼 하락 (FW)", desc: "최근 5경기 출전 쿼터 기준, FW 포지션에서 공격포인트 0~1개에 수렴하면서 FW 출전 시 코트 마진이 마이너스인 선수에게 경고가 표시됩니다." },
      { term: "📉 폼 하락 (DF/GK)", desc: "최근 5경기 출전 쿼터 기준, DF 또는 GK 포지션 출전 시 쿼터당 평균 실점이 2.0 이상으로 팀 내 최악의 자동문 수준인 선수에게 경고가 표시됩니다." },
      { term: "포지션별 팀 승률", desc: "선수가 특정 포지션(FW/DF/GK/MF)으로 뛰었을 때 해당 쿼터의 팀 승률. AI 스카우팅 리포트에서 포지션 배치 권장사항의 근거로 사용됩니다." },
      { term: "🛡️ 까방권 보유", desc: "최근 3경기 중 한 경기에서 해트트릭(3골) 이상을 기록한 선수. 잠시 폼 하락 경고에서 면제됩니다." },
    ],
  },
  {
    title: "📋 포메이션별 통계 가이드",
